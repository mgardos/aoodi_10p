...
public class NumeroTest {
	...
	public void test06SumaDeFracciones() {
		 ...
		 * a/b + c/d = (a.d + c.b) / (b.d)
		 * 
		 * SI ESTAN PENSANDO EN LA REDUCCION DE FRACCIONES NO SE PREOCUPEN! TODAVIA NO
		 * SE ESTA TESTEANDO ESE CASO
		 */
	}
	...
	/*
	 * Ahora empieza lo lindo! - Primero hacemos que se puedan sumar enteros con
	 * fracciones y fracciones con enteros
	 */
	@Test
	...
	public void test16LasFraccionesAparentesSonIguales() {
		...
		/*
		 * Las fracciones se reducen utilizando el maximo comun divisor (mcd) Por lo
		 * tanto, para a/b, sea c = mcd (a,b) => a/b reducida es: (a/c) / (b/c).
		 * 
		 * Por ejemplo: a/b = 2/4 entonces c = 2. Por lo tanto 2/4 reducida es: (2/2) /
		 * (4/2) = 1/2
		 * 
		 * Para obtener el mcd pueden usar el algoritmo de Euclides que es:
		 * 
		 * mcd (a,b) = si b = 0 --> a si b != 0 -->mcd(b, restoDeDividir(a,b))
		 * 
		 * Ejemplo: mcd(2,4) -> mcd(4,restoDeDividir(2,4)) -> mcd(4,2) ->
		 * mcd(2,restoDeDividir(4,2)) -> mcd(2,0) -> 2
		 */
	}
